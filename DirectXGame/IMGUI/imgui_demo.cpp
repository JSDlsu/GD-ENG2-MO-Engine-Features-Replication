...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Basic"))
    {
        ...
        // BNS_Color buttons, demonstrate using PushID() to add unique identifier in the ID stack, and changing style.
    ...
    IMGUI_DEMO_MARKER("Widgets/BNS_Color");
    if (ImGui::TreeNode("BNS_Color/Picker Widgets"))
    {
        ...
        IMGUI_DEMO_MARKER("Widgets/BNS_Color/ColorEdit");
        ImGui::Text("BNS_Color widget:");
        ImGui::SameLine(); HelpMarker(
            "Click on the color square to open a color picker.\n"
            "CTRL+click on individual component to input value.\n");
        ImGui::ColorEdit3("MyColor##1", (float*)&color, misc_flags);

        IMGUI_DEMO_MARKER("Widgets/BNS_Color/ColorEdit (HSV, with Alpha)");
        ImGui::Text("BNS_Color widget HSV with Alpha:");
        ImGui::ColorEdit4("MyColor##2", (float*)&color, ImGuiColorEditFlags_DisplayHSV | misc_flags);

        IMGUI_DEMO_MARKER("Widgets/BNS_Color/ColorEdit (float display)");
        ImGui::Text("BNS_Color widget with Float Display:");
        ImGui::ColorEdit4("MyColor##2f", (float*)&color, ImGuiColorEditFlags_Float | misc_flags);

        IMGUI_DEMO_MARKER("Widgets/BNS_Color/ColorButton (with Picker)");
        ImGui::Text("BNS_Color button with Picker:");
        ImGui::SameLine(); HelpMarker(
        ...
        IMGUI_DEMO_MARKER("Widgets/BNS_Color/ColorButton (with custom Picker popup)");
        ImGui::Text("BNS_Color button with Custom Picker Popup:");
        ...
        IMGUI_DEMO_MARKER("Widgets/BNS_Color/ColorButton (simple)");
        ImGui::Text("BNS_Color button only:");
        static bool no_border = false;
        ImGui::Checkbox("ImGuiColorEditFlags_NoBorder", &no_border);
        ImGui::ColorButton("MyColor##3c", *(ImVec4*)&color, misc_flags | (no_border ? ImGuiColorEditFlags_NoBorder : 0), ImVec2(80, 80));

        IMGUI_DEMO_MARKER("Widgets/BNS_Color/ColorPicker");
        ImGui::Text("BNS_Color picker:");
        ...
        {
            ImGui::SameLine();
            ImGui::Checkbox("With Ref BNS_Color", &ref_color);
            if (ref_color)
            {
                ImGui::SameLine();
        ...
        ImGui::Text("BNS_Color widget with InputHSV:");
    ...
    if (ImGui::TreeNode("Drag and Drop"))
    {
        ...
        if (ImGui::TreeNode("Drag and drop in standard widgets"))
        {
            ...
            // Also see 'Demo->Widgets->BNS_Color/Picker Widgets->Palette' demo.
...
static void ShowExampleAppCustomRendering(bool* p_open)
{
    ...
    if (ImGui::BeginTabBar("##TabBar"))
    {
        if (ImGui::BeginTabItem("Primitives"))
        {
            ...
            ImGui::ColorEdit4("BNS_Color", &colf.x);
