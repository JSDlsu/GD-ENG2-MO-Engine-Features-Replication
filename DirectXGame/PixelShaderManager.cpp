...
void PixelShaderManager::ChangePixelShader(PixelShaderPtr& m_vs, BNS_PixelShaderType ps_type)
{
...
BNS_ShaderByteData PixelShaderManager::GetPixelShaderData(BNS_PixelShaderType ps_type)
{
