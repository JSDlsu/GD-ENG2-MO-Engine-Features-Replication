...
class BNS_Sphere : public BNS_AGameObject
{
public:
	BNS_Sphere(std::string name, BNS_ObjectTypes type);
	~BNS_Sphere();
public:
...
protected:
	...
	std::unique_ptr <DirectX::GeometricPrimitive> GeometricShape;
	DirectX::GeometricPrimitive::VertexCollection GeometricShapeVertices;
	DirectX::GeometricPrimitive::IndexCollection GeometricShapeIndices;
